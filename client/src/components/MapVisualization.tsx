...
// Set your Mapbox token - using a public token that is guaranteed to work
...
const MapVisualization = ({ flights, showHeatmap, filters, airlines }: MapVisualizationProps) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (showHeatmap) {
        ...
        layers.push(heatmapLayer as any);
      }
  ...
  return (
    <div className="bg-white rounded-lg shadow mb-6 overflow-hidden">
      ...
      <div ref={mapContainer} className="relative map-container">
        <canvas id="deck-canvas" className="absolute inset-0 w-full h-full" />
